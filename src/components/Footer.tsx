  ...
  return (
    <div className="py-5 md:py-8 lg:py-12 border-t-2 ">
      <div className="max-w-screen-lg mx-auto">
        <h3 className="text-white text-4xl pb-8 tracking-wider font-bold ">
          Dutch Rabbit
        </h3>
        <div className="flex flex-col md:flex-row md:justify-between items-end border-b-2 py-6">
        ...
        <div className="flex flex-col pt-6 gap-3 text-white items-start">
